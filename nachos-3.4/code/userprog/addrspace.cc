...
AddrSpace::AddrSpace(char *filename)
{
    ...
    int numFreePages = gPhysPageBitMap->NumClear();
    if (numPages > numFreePages)
    {
    ...
    // test
    // printf("\ncode size = %d, numCodePage = %d, lastCodePageSize = %d", noffH.code.size, numCodePage, lastCodePageSize);
    // printf("\ninitData size = %d, numDataPage = %d, lastDataPageSize = %d, firstDataPageSize = %d", noffH.initData.size, numDataPage, lastDataPageSize, firstDataPageSize);
    delete executable;
}
